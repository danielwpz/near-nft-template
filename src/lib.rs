...
pub struct Contract {
    ...
    creator_royalty_bp: Option<BasisPoint>,
}
...
impl Contract {
    ...
    pub fn new(
        ...
        if let Some(_) = creator_id {
            require!(
                creator_royalty_bp != None,
                "Must specify creator royalty bp"
            );
        }
...
mod tests {
    ...
    pub(crate) fn sample_token_metadata() -> TokenMetadata {
        TokenMetadata {
